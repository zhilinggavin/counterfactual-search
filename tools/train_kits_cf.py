...
def main(args):
    ...
    expriment = None
    # wandb.init(project="COIN", name="cf_inpainting_kits", config=opt)
    # expriment = wandb.run
...
if __name__ == '__main__':
    ...
    args.config_path = (
        '/media/NAS06/gavinyue/disentanglement/benchmark/counterfactual-search/configs/counterfactual/paper_experiments/tuh/cf_inpainting_kits.yaml'
    )
    main(args)
