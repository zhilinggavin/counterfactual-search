...
def main(args):
    ...
    wandb.init(project='COIN', name='kits_classification_lowthre')
    expriment = wandb.run
...
if __name__ == '__main__':
    ...
    args.config_path = (
        '/media/NAS06/gavinyue/disentanglement/benchmark/counterfactual-search/configs/classification/kits_tumours/effv2s_kits_tumors_lowthre.yaml'
    )
